...
| 资产 | 说明 |
| --- | --- |
| `YuMark-v0.8.apk` | 当前正式 APK，作为 GitHub Release 附件发布 |
| `RELEASE_NOTES_v0.8.md` | v0.8 详细更新说明：导出补完（PDF/Word/长图）、历史版本、平板与折叠屏、WebDAV 同步、Agent 架构重写 |
| SHA256 | `1b238680ca6ee0abbd8641d9b58541860b20b4b7481586ce60e8bc51cfabd66b` |
...
| PDF 导出 | 已支持，复用预览渲染管线（KaTeX/Mermaid/Prism）经 PdfDocument 分页输出 |
| Word 导出 | 已支持，Commonmark AST → 手写 OOXML 生成 `.docx`（无 Apache POI 依赖） |
| 图片导出 | 已支持，整页渲染截成 PNG 长图 |
